...
public interface ControllerInterface {
     ...
     * @param src Source Node Address that sends the function.
     * @param dest Destination Node Address that receives the function.
     * @param nextHop NextHop Node Address between Source and Destination.
     * @param id byte value to identifies functions to send.
     * @param className string value for the function to send.
     */
    void sendFunction(byte netId, NodeAddress src, NodeAddress dest, NodeAddress nextHop, byte id, String className);
    ...
    /**
     * Setter Method to set a ControllerId.
     * 
     * @param id Controller Identity will be set
     */
    void setId(ControllerId id);
    ...
    /**
     * Method called when the network starts.
     * It could be used to configuration rules or network at the beginning
     * of the application.
     */
    void setupNetwork();

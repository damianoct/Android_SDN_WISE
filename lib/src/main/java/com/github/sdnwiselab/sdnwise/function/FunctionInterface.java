...
public interface FunctionInterface {  
     ...
     * action SDN_WISE_FORWARD_UP and the corresponding ID of the function.
     * A function can be installed in a node by using the sendFunction method
     * of a controller.
     * 
     ...
     * @param neighborTable an ArrayList containing the Neighbors table of 
     * the node. 
     * @param statusRegister an int[] containing the status of the node.
     * @param acceptedId an ArrayList of NodeAddress containing the aliases 
     * for the address of the node.
     * @param flowTableQueue messages added in this queue will be matched 
     * in the flow table.
     * @param txQueue messages added in this queue will be sent immediately.
     * @param value is a parameter passed by the action.
